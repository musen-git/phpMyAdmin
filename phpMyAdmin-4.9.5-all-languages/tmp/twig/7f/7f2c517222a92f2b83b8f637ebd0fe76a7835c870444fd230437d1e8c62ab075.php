...
";
    ...
    {
        return new Source("", "database/structure/favorite_anchor.twig", "/data/phpadmin/phpMyAdmin-4.9.5-all-languages/templates/database/structure/favorite_anchor.twig");
    }
}
