...
";
    ...
    {
        return new Source("", "database/structure/print_view_data_dictionary_link.twig", "/data/phpadmin/phpMyAdmin-4.9.5-all-languages/templates/database/structure/print_view_data_dictionary_link.twig");
    }
}
